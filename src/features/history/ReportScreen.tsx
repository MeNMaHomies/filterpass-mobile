  ...
  return (
    ...
    >
        ...
        <View style={styles.summaryGrid}>
          {[
            ...
            >
              ...
              <Text style={[styles.summaryValue, { color: c as string }]}>{v}</Text>
            </View>
          ))}
        </View>
      </Card>
      ...
      <Card style={styles.section}>
        ...
        <Svg width="100%" height={100} viewBox="0 0 320 100" style={styles.chart}>
          <Defs>
          ...
          <Line x1={0} y1={50} x2={320} y2={50} stroke={colors.muted2} strokeDasharray="4 4" opacity={0.4} />
          <Path
      ...
      <View style={styles.chartsRow}>
        ...
        <Card style={styles.donutCard}>
          ...
          <Svg width={80} height={60} viewBox="0 0 80 60">
            <Circle cx={40} cy={30} r={24} fill="none" stroke={colors.border} strokeWidth={8} />
            <Circle
              cx={40}
              cy={30}
              r={24}
      ...
      <Card style={styles.timeline}>
        {reportChunks.map((c, i) => (
          <View
            key={c.time}
            style={[styles.timelineRow, i < reportChunks.length - 1 && styles.timelineBorder]}
          >
            <Text style={styles.timelineTime}>{c.time}</Text>
            <Text style={[styles.timelineScore, { color: scoreColor(c.score) }]}>
              {c.score.toFixed(2)}
            </Text>
