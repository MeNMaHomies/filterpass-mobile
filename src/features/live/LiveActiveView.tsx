  ...
  return (
    ...
    >
      ...
      <Card style={styles.section}>
        ...
        <Svg width="100%" height={44} viewBox="0 0 300 44" preserveAspectRatio="none" style={styles.waveform}>
          <Path
      ...
      <Button variant="danger" label="Stop session" style={styles.stopBtn} onPress={onStop} />
    </ScrollView>
  );
}
