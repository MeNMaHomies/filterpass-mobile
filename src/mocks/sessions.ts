...
export const historySessions: HistorySession[] = [
  { id: 'a3f9c2e1', label: 'REAL', score: 0.18, duration: '4m 12s', ago: '2h ago' },
  { id: 'b7e19a44', label: 'SPOOF', score: 0.72, duration: '1m 08s', ago: '5h ago' },
  { id: 'c4d21f88', label: 'REAL', score: 0.44, duration: '6m 33s', ago: '1d ago' },
];
...
export const liveChunkHistory = [0.22, 0.28, 0.31, 0.35, 0.29, 0.33, 0.27, 0.24, 0.26, 0.28];
