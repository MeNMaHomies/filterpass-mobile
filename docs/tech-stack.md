...
**Planned:** TanStack Query v5 (`@tanstack/react-query`) for REST server state — see [`react-query-migration.md`](./react-query-migration.md). WebSockets / live capture stay outside Query.
